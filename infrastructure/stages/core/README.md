...
- explicit EKS add-on ownership for `vpc-cni`
...
The `core` stage does not create namespaces, Helm releases, CoreDNS, workloads, or policy CRDs anymore. Those live in the `platform`, `policies`, and `applications` stages.
